...
class DFPreTrainedModel(PreTrainedModel):
    config_class = Config
...
class CausalLM(DFPreTrainedModel):
...
class SequenceClassification(DFPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class QuestionAnswering(DFPreTrainedModel):
